...
sentiment_analyzer = pipeline("sentiment-analysis", model="kinit/slovakbert-sentiment-twitter")

# def split_into_chunks(lyrics, chunk_size=512):
#     return [lyrics[i:i+chunk_size] for i in range(0, len(lyrics), chunk_size)]

tokenizer = AutoTokenizer.from_pretrained("kinit/slovakbert-sentiment-twitter")
